...
def test_get_files(file_system):
    ...
    main_file1 = file_system["main"]["file1"].as_posix()
    assert main_file1 == files[0], "Not expected file"
...
def test_get_files_recursive(file_system):
    ...
    sub_fil1 = file_system["sub"]["file1"].as_posix()
    assert sub_fil1 == files[1], "Not expected file"

    sub_sub_file1 = file_system["subsub"]["file1"].as_posix()
    assert sub_sub_file1 == files[2], "Not expected file"
...
def test_get_directories(file_system):
    ...
    """
    main_dir = file_system["main"]["dir"]
    directories = MockOperationBase.get_directories(main_dir, False)
...
def test_get_directories_recursive(file_system):
    ...
    """
    main_dir = file_system["main"]["dir"]
    directories = MockOperationBase.get_directories(main_dir, True)
