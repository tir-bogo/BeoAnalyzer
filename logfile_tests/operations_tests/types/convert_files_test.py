...
def test_list_item_in_string_match():
    ...
    assert ConvertFiles.list_item_in_string(test_arr, test_item)
...
def test_list_item_in_string_no_match():
    ...
    test_item = "c:/test/path/file.txt"
    test_arr = [".log", ".exe"]
    assert not ConvertFiles.list_item_in_string(test_arr, test_item)
...
def test_list_item_in_string_arg_item_none():
    ...
    """
    test_arr = [".log", ".exe"]
    assert not ConvertFiles.list_item_in_string(test_arr, None)
...
def test_list_item_in_string_arg_arr_none():
    ...
    """
    test_item = "c:/test/path/file.txt"
    assert not ConvertFiles.list_item_in_string(None, test_item)
...
def test_convert_file(file_system):
    ...
    parent = file_system["main"]["file1"].parent
    main_file1_name = (file_system["main"]["file1"].name + ".log")
    main_file1 = parent / main_file1_name
...
def test_sort_files_match():
    ...
    test_filter = [".txt", ".exe"]
    test_filepaths = []
    test_filepaths.append("c:/test.txt")
    test_filepaths.append("c:/test2.exe")
    test_filepaths.append("c:/test3.log")
    test_filepaths.append("c:/test4.mov")
