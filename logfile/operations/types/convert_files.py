...
class ConvertFiles(OperationBase):
    ...
    @staticmethod
    def __list_item_contains_in_string(arr: list, item: str) -> bool:
        """
    ...
    def run(self) -> bool:
        ...
        try:
            ...
            for filepath in files:
                if self.__list_item_contains_in_string(exclude_files, filepath) or \
                   self.__list_item_contains_in_string(exclude_ext, filepath):
